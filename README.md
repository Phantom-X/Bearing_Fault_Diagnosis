...
<img src="images/图片1.png" alt="PhantomCNN overall structure diagram" title="PhantomCNN overall structure diagram" width="50%" height="auto">
...
<img src="images/图片2.png" alt="Lightweight multi-angle feature fusion module (PhantomLayer) structure diagram" title="Lightweight multi-angle feature fusion module (PhantomLayer) structure diagram" width="80%" height="auto">
...
<img src="images/参数对比.png" alt="Model parameter comparison chart" title="Model parameter comparison chart" width="80%" height="auto">
...
<img src="images/图片3.png" alt="CWRU dataset D recognition accuracy line chart of different methods with different signal-to-noise ratios" title="CWRU dataset D recognition accuracy line chart of different methods with different signal-to-noise ratios" width="80%" height="auto">
...
<img src="images/图片5.png" alt="t-SNE dimensionality reduction diagram of PhantomCNN feature maps at different layers when the signal-to-noise ratio is 8dB" title="t-SNE dimensionality reduction diagram of PhantomCNN feature maps at different layers when the signal-to-noise ratio is 8dB" width="80%" height="auto">

#### 4. Accuracy line chart of different models fine-tuned by 1%-5% natural damage dataset samples:

<img src="images/图片6.png" alt="1%-5% natural damage dataset sample fine-tuned accuracy line chart of different models" title="1%-5% natural damage dataset sample fine-tuned accuracy line chart of different models" width="80%" height="auto">
